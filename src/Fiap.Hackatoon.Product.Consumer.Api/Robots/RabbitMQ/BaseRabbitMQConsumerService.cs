...
public abstract class BaseRabbitMQConsumerService : BackgroundService
{
    ...
    public BaseRabbitMQConsumerService(IServiceProvider serviceProvider, IOptions<ConsumerSettings> option, ILogger logger, string exchange = null)
    {
    ...
    protected override Task ExecuteAsync(CancellationToken stoppingToken)
    {
        ...
        _channel.QueueDeclare(QueueError, true, false, false, null);
        _channel.QueueBind(QueueError, _exchange, RoutingKeyError, null);
        ...
        consumer.Received += async (model, ea) =>
        {
            ...
            try
            {
                ...
                var service = scope.ServiceProvider.GetRequiredService<IProductApplicationService>();
                if (service != null)
                {
